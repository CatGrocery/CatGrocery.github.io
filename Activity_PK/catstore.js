...
function ShowAnnouncement()
{
    if(NowCanva != 'announcement')
    {
            ...
            var url="https://script.google.com/macros/s/AKfycbyOLQuUIZconcJ9zVq0FiBVER8Rm7r9tBRSOuk_aehqhUFJKL-9qTb6fZnekw1YzHtH2g/exec";
...
function ShowMember()
{
    if(NowCanva == 'member')
    {
            ...
            var randomnum =	Math.round(Math.random() * (5 - 1)) + 1;
            document.getElementById("member_status").innerHTML= '<img src="https://cdn.jsdelivr.net/gh/Faxey/Cat_Store/props/loading0'+randomnum+'.gif" style="display:block; margin:auto;">';
            var xmlhttp;
                if (window.XMLHttpRequest)
                {// code for IE7+, Firefox, Chrome, Opera, Safari
                xmlhttp=new XMLHttpRequest();
                ...
                xmlhttp.onreadystatechange=function()
                {
                        if (xmlhttp.readyState==4 && xmlhttp.status==200)      
                        {
                                ...
                                for (var i = 0; i < obj.length; i ++ ) 
                                    {
                                        if(obj[i].data[0] == '報名成功')
                                        {
                                            ...
                                            html +='</div></span></a></h6><div id="member'+obj[i].data[1]+'" class="collapse" data-parent="#accordion-job" aria-expanded="false"><div class="card-body"><p class="announcement" style="text-align: left;">隊員1&emsp;'+obj[i].data[4]+'&emsp;'+obj[i].data[3]+'<br>隊員2&emsp;'+obj[i].data[6]+'&emsp;'+obj[i].data[5]+'<br>隊員3&emsp;'+obj[i].data[8]+'&emsp;'+obj[i].data[7]+'<br>隊員4&emsp;'+obj[i].data[10]+'&emsp;'+obj[i].data[9]+'<br>隊員5&emsp;'+obj[i].data[12]+'&emsp;'+obj[i].data[11]+'<br>候補1&emsp;'+obj[i].data[14]+'&emsp;'+obj[i].data[13]+'</p><p></p></div></div></div>';
                                        }
                                        //html  +='<div class="w-100 jobboard-card-child" data-shuffle="item"><h6  class="card-title" style="background-color: rgb(243, 238, 232)"><a data-toggle="collapse" class="d-flex align-items-center collapsed" href="#'+obj[i].data[4]+'">';
                                        //html  += '<span class="mr-5"><img loading="lazy" class="avatar avatar-s lazyloaded"  src="' + obj[i].data[6] + '" alt=""></span>';
                                        //html  +='<span class="mr-auto w-60"><strong style="font-size: 20px;">'+obj[i].data[0]+ '</strong><br><br>';
                                ...
                                document.getElementById("member_status").innerHTML=html;
            ...
            var url="https://script.google.com/macros/s/AKfycbyOLQuUIZconcJ9zVq0FiBVER8Rm7r9tBRSOuk_aehqhUFJKL-9qTb6fZnekw1YzHtH2g/exec";
                ...
                xmlhttp.open("get",url+"?type=member",true);
                xmlhttp.send();
